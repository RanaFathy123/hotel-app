...
setBooking(booking)
  ...
  borderRadius:5,
  p: 5,}}>
    <Typography id="modal-modal-title" variant="h5" component="h2" textAlign='center' color={colors.blue[900]} marginBottom={5}>
            ...
            <TableBody>
              {bookingList?.map((Book: any) => (
                <StyledTableRow key={Book._id}>
                  ...
                  <StyledTableCell >{new Date(Book.startDate).toLocaleDateString()}</StyledTableCell>
                  <StyledTableCell >
